...
```component VPCard
{
  ...
  "link": "/explore/articles/freecodecamp.org/create-personalized-github-profile-page.md",
  "logo": "https://cdn.freecodecamp.org/universal/favicons/favicon.ico",
...
```component VPCard
{
  ...
  "link": "/explore/articles/engineering.linecorp.com/increase-vm-performance-to-reduce-global-warming.md",
  "logo": "https://engineering.linecorp.com/favicon-32x32.png?v=6d6085f233d02c34273fa8a8849b502a",
  "background": "rgba(31,31,31,0.2)"
}
```
