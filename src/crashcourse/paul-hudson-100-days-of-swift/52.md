...
meta:
  ...
  - property: og:url
    content: https://chanhi2000.github.io/explore/crashcourse/paul-hudson-100-days-of-swift/52.html
---
...
That's it for the storyboard, so bring up <FontIcon icon="iconfont icon-file"/> `ViewController.swift` and let's start coding…
