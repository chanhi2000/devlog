...
meta:
  ...
  - property: og:url
    content: https://chanhi2000.github.io/explore/crashcourse/paul-hudson-100-days-of-swiftui/40.html
---
...
Add this to <FontIcon icon="iconfont icon-file"/>`Bundle-Decodable.swift` now:
...
The problem _now_ is this line of code in <FontIcon icon="iconfont icon-file"/> `ContentView.swift`:
