...
lang: ko-KR
title: Intro
description: 🔺Red Hat Containerize Your Application With Buildah And Podman
tags: ["crashcourse", "redhat", "buildah", "podman", "skopeo", "sesearch", "semodule"]
meta:
  - name: 🔺Red Hat Containerize Your Application With Buildah And Podman
    content: 🔺Red Hat Containerize Your Application With Buildah And Podman
  - property: og:title
    content: 🔺Red Hat Containerize Your Application With Buildah And Podman
  - property: og:description
    content: An Overview of Container Tools
  - property: og:url
    content: https://chanhi2000.github.io/crashcourse/red-hat-containerize-your-application-w-buildah-and-podman
---
...
desc: An Overview of Container Tools
link: https://developers.redhat.com/courses/red-hat-containerize-your-application-w-buildah-and-podman
...
- [1. Using the Fast and Stable Streams][01]
- [2. Podman - Familiar Territory][02]
- [3. Buildah - Granularity & Control][03]
- [4. Skopeo: Moving & Sharing][04]
