...
meta:
  ...
  - property: og:url
    content: https://chanhi2000.github.io/crashcourse/devops-freecodcamp-gitlab-ci/2.html
---
...
- [<FontIcon icon="iconfont icon-gitlab"/> `gitlab-course-public/devops-freecodcamp-gitlab-ci` (fork this)](https://gitlab.com/gitlab-course-public/devops-freecodcamp-gitlab-ci)
