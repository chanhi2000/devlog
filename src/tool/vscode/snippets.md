...
```json :collapsed-lines title="markdown.json"
{
  ...
  "MdCodeTabsLinuxInstall": {
    ...
    "body": [
      ...
      "",
      "```sh",
      "sudo apt install ${1:packagename}",
      "```",
      "",
