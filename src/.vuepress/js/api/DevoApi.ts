...
const jsonFullPathsLang = [
  "android", "assembly", "awk", "batchfile", "blade", "c", "clojure", "common-lisp", "cpp", "crystal", "csharp", "dart", "dockerfile", "elixir", "elm", "gdscript", "go", "haskell", "hcl", "java", "js", "julia", "jupyter-notebook", "kotlin", "lua", "nextflow", "objc", "ocaml", "prolog", "php", "pwsh", "python", "qml", "r", "ruby", "rust", "scala", "scss",  "sh", "solidity", "swift", "tex", "ts", "v", "vala", "vdhl", "verilog", "vim-script", "zig"
