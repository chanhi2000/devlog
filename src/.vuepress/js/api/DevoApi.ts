...
const jsonFullPathsLang = [
  "android", "assembly", "awk", "batchfile", "blade", "c", "clojure", "common-lisp", "cpp", "crystal", "csharp", "dart", "dockerfile", "elixir", "elm", "gdscript", "go", "haskell", "hcl", "java", "js", "js-react", "js-svelte", "julia", "jupyter-notebook", "kotlin", "lua", "nextflow", "objc", "ocaml", "prolog", "php", "pwsh", "python", "qml", "r", "ruby", "rust", "scala", "scss",  "sh", "solidity", "swift", "tex", "ts", "ts-react", "ts-svelte", "v", "vala", "vdhl", "verilog", "vim-script", "zig"
].map((e: string) => `${PUBLIC_GITHUB_BASEPATH}/lang-${e}.json`);

const jsonFullPathsLangTut = [
  "c", "cpp", "csharp", "dart", "dockerfile", "go", "java", "android", "js", "jupyter-notebook", "kotlin", "lua", "php", "pwsh", "python", "ruby", "rust", "sh", "swift", "ts"
