<!-- .vuepress/components/DevGeekNewsItems -->
<template>
    <div class="card-title" style="background-color: rgb(49, 54, 62); color: rgb(254, 101, 1);">
      ...
      <div class="card-title-text">
        <div data-v-3564cb40="" class="round-borders wrapper">
          <div data-v-3564cb40="" class="select-title-wrapper">
            <span data-v-3564cb40="" class="select-title"> GeekNews</span>
          </div>
        </div>
      </div>
  ...
  import GeekNewsApi from '../js/api/GeekNewsApi'

  export default {
    name: "DevGeekNewsItems",
    ...
    methods: {
      async onFetchData() {
        ...
        const fetchedItems = await GeekNewsApi.fetchGeekNews()
