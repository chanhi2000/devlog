...
<template>
  <div class="card-title" style="background-color: rgb(49, 54, 62); color: rgb(255, 255, 255);">
  ...
  methods: {
    async fetchData() {
      ...
      let jsonFullPathsLang = [
        "batchfile", "c", "cpp", "csharp", "dart", "go", "hcl", "java", "android", "js", "jupyter-notebook", "kotlin", "php", "pwsh", "python", "ruby", "rust", "sh", "swift", "ts", "vim-script"
