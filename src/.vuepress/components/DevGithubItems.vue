  ...
  methods: {
    async fetchData() {
      ...
      let jsonFullPathsLang = [
        "batchfile", "blade", "c", "common-lisp", "cpp", "crystal", "csharp", "dart", "dockerfile", "go", "hcl", "java", "android", "js", "julia", "jupyter-notebook", "kotlin", "lua", "ocaml", "php", "pwsh", "python", "ruby", "rust", "sh", "solidity", "swift", "ts", "vim-script", "zig"
