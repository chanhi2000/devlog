...
<template>
  <div v-if="hasData"
    ...
    <div class="card-title-text">
      <div data-v-3564cb40="" class="round-borders wrapper">
        <div data-v-3564cb40="" class="select-title-wrapper">
          <span data-v-3564cb40="" class="select-title"> GitHub Trending</span>
          <span data-v-3564cb40="" class="select-icon">
            <svg data-v-3564cb40="" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="caret-down" role="img" xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 320 512" class="svg-inline--fa fa-caret-down fa-w-10">
              <path data-v-3564cb40="" fill="currentColor" d="M31.3 192h257.3c17.8 0 26.7 21.5 14.1 34.1L174.1 354.8c-7.8 7.8-20.5 7.8-28.3 0L17.2 226.1C4.6 213.5 13.5 192 31.3 192z"></path>
            </svg>
          </span>
        </div>
      </div>
    ...
    <div class="pull-right external-icons">
      <div class="title-icon external-icon" style="color: rgba(255, 255, 255, 0.7);">
      ...
      <div class="title-icon refresh-icon" style="color: rgba(255, 255, 255, 0.7);">
        <a @click="doRefresh">
          <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="sync-alt" role="img" xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512" class="fa-refresh-icon svg-inline--fa fa-sync-alt fa-w-16">
  ...
  methods: {
    async fetchData() {
      ...
      let jsonFullPathsLang = [
        "batchfile", "blade", "c", "common-lisp", "cpp", "crystal", "csharp", "dart", "dockerfile", "elixir", "gdscript", "go", "haskell", "hcl", "java", "android", "js", "julia", "jupyter-notebook", "kotlin", "lua", "ocaml", "php", "pwsh", "python", "ruby", "rust", "scala", "sh", "solidity", "swift", "tex", "ts", "v", "verilog", "vim-script", "zig"
