...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/explore/articles/hackingwithswift.com/concurrency/
---
...
```component VPCard
{
  ...
  "link": "/explore/articles/hackingwithswift.com/concurrency/this-stuff-is-hard.md"
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(54,94,226,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/explore/articles/hackingwithswift.com/concurrency/how-to-follow-this-guide.md"
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(54,94,226,0.2)"
}
```
...
```component VPCard
{
  ...
  "desc": "Dedication",
  "link": "/explore/articles/hackingwithswift.com/concurrency/dedication.md"
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(54,94,226,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/explore/articles/hackingwithswift.com/concurrency/how-to-make-a-task-sleep.md"
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(54,94,226,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/explore/articles/hackingwithswift.com/concurrency/how-to-voluntarily-suspend-a-task.md"
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(54,94,226,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/explore/articles/hackingwithswift.com/concurrency/how-to-make-async-command-line-tools-and-scripts.md"
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(54,94,226,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/explore/articles/hackingwithswift.com/concurrency/how-to-make-function-parameters-isolated.md"
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(54,94,226,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/explore/articles/hackingwithswift.com/concurrency/how-to-download-json-from-the-internet-and-decode-it-into-any-codable-type.md"
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(54,94,226,0.2)"
}
```
