...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/explore/articles/hackingwithswift.com/swiftui-by-example/what-is-the-fetchrequest-property-wrapper.html
---
...
Before using `@FetchRequest` you must first have injected a Core Data managed object context into the environment – see [how to access a Core Data managed object context from a SwiftUI view](/explore/articles/hackingwithswift.com/swiftui-by-example/how-to-access-a-core-data-managed-object-context-from-a-swiftui-view.mdd) for instructions on how to do that.
