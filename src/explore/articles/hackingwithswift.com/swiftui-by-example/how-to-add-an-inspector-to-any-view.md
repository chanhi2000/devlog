...
![A button that opens then closes an inspector window when pressed.](https://www.hackingwithswift.com/img/books/quick-start/swiftui/how-to-add-an-inspector-to-any-view-1~dark@2x.gif)
