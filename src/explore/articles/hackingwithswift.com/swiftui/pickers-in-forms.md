...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/explore/articles/hackingwithswift.com/swiftui/pickers-in-forms.html
---
...
```component VPCard
{
  ...
  "link": "/explore/articles/hackingwithswift.com/swiftui/two-way-bindings-in-swiftui.html",
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(54,94,226,0.2)"
}
```
