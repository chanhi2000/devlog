...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/explore/articles/hackingwithswift.com/read/35/02-generating-random-numbers-without-gameplaykit.html
isOriginal: false
---
...
That uses modulus to ensure that the result from `arc4random()` falls within a specific range. [We already covered modulus in project 8](/explore/articles/hackingwithswift.com/read/08/overview.md) so skip back there if you need a refresher. Note that we need to specify 6 because the values range from 0 to 5 inclusive.
