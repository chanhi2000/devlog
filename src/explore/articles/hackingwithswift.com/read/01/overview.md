...
```component VPCard
{
  ...
  "desc": "Setting up",
  "link": "/explore/articles/hackingwithswift.com/read/01/01-setting-up.md",
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(174,10,10,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/explore/articles/hackingwithswift.com/read/01/02-listing-images-with-filemanager.md",
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(174,10,10,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/explore/articles/hackingwithswift.com/read/01/03-designing-our-interface.md",
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(174,10,10,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/explore/articles/hackingwithswift.com/read/01/04-building-a-detail-screen.md",
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(174,10,10,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/explore/articles/hackingwithswift.com/read/01/05-loading-images-with-uiimage.md",
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(174,10,10,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/explore/articles/hackingwithswift.com/read/01/06-final-tweaks-hidesbarsontap-and-large-titles.md",
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(174,10,10,0.2)"
}
```
...
```component VPCard
{
  ...
  "desc": "Wrap up",
  "link": "/explore/articles/hackingwithswift.com/read/01/07-wrap-up.md",
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(174,10,10,0.2)"
}
```
...
I put together answers for over 600 of the most frequently asked questions I received from readers into one place: [the Swift 5 Knowledge Base](/explore/articles/hackingwithswift.com/example-code/README.md). It answers basic and advanced questions, and provides lots of free code you can re-use however you please. If you hit problems, try searching there first.
