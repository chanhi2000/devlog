...
head:
  - - meta:
    ...
    - property: og:description
      content: Summary
    - property: og:url
      content: https://chanhi2000.github.io/explore/articles/freecodecamp.org/gitting-things-done-book/summary.html
date: 2024-01-08
isOriginal: false
...
- [The Git Rebase Handbook](/explore/articles/freecodecamp.org/git-rebase-handbook.md)
- [The Git Merge Handbook](/explore/articles/freecodecamp.org/the-definitive-guide-to-git-merge.md)
- [The Git Diff and Patch Handbook](/explore/articles/freecodecamp.org/git-diff-and-patch.md)
- [Git Internals - Objects, Branches, and How to Create a Repo](/explore/articles/freecodecamp.org/git-internals-objects-branches-create-repo.md)
- [Git Reset Command Explained](/explore/articles/freecodecamp.org/save-the-day-with-git-reset.md)
