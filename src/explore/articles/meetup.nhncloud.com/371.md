...
Android PLT(procedure linkage table) hook과 관련해 plt hook 당한 함수를 식별하는 방법을 공유하고자 합니다. plt hook 라이브러리로는 bytedance에서 오픈소스로 공개한 bhook(<a href="https://github.com/bytedance/bhook" target="_blank">https://github.com/bytedance/bhook</a>)이 많이 사용되고 있는 것으로 보입니다.
