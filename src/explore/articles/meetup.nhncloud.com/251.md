...
date: 2020-08-27
isOriginal: false
cover: /images/content/meetup.nhncloud.com/251/banner.png
---
...
![레디스에 키가 있는지 `EXISTS` 커맨드로 확인](/images/content/meetup.nhncloud.com/251/11.png)

![없을 때 DB에 가서 데이터를 읽어온 뒤 레디스에 `SET`](/images/content/meetup.nhncloud.com/251/12.png)
