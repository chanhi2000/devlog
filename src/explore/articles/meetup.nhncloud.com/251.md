...
![](/images/content/meetup.nhncloud.com/251/8.png)
...
![여러 가지 압축 프로그램을 벤치마크 툴로 확인하여 적절한 프로그램을 찾는 과정 또한 필요합니다.](/images/content/meetup.nhncloud.com/251/9.png)

![평소 크기가 큰 데이터를 그대로 레디스에 저장했다면, 압축만 수행해도 아래처럼 두배 가까이 성능 향상을 발생시킬 수 있습니다.](/images/content/meetup.nhncloud.com/251/10.png)
