...
![그림 Chrome Canary 87.0.4243.0의 `navigator.userAgentData`](https://d2.naver.com/content/images/2020/09/1_TiRYp-mF9LytV_jhenGJrw.png)

![그림 Edge 85.0.564.44의 `navigator.userAgentData`](https://d2.naver.com/content/images/2020/09/1_hSoC7ZZtt7FtkIdM-tbEDw.png)
...
![<FontIcon icon="iconfont icon-macos"/>Mac OS X 10.15.4, Chrome Canary 87.0.4243.0의 `navigator.userAgentData.getHighEntropyValues` 호출 결과](https://d2.naver.com/content/images/2020/09/1_I5WwON3017WRQ-O2AqxbdQ.png)
