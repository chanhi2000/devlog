...
The naming convention I like to use is the name of the command and append *Validator*. You can also enforce this by writing [architecture tests.](/explore/articles/milanjovanovic.tech/enforcing-software-architecture-with-architecture-tests.md)
...
So, all you need is a way to implement middleware and place your validation inside. And I like having options, so here are [three ways to create middleware in ASP.NET Core.](/explore/articles/milanjovanovic.tech/3-ways-to-create-middleware-in-asp-net-core.md)
