...
The **Options pattern** allows us to use classes to provide strongly typed
...
## strongly-typed-configuration"><a href="#strongly-typed-configuration">Strongly Typed Configuration
...
## what-could-go-wrong"><a href="#what-could-go-wrong">What Could Go Wrong?
...
<li>Forgetting to add the settings values in `appsettings.json`
<li>Typo in a property name in the class or in the configuration
<li>Unbindale properties without a setter
<li>Data type mismatch resulting in incompatible values
...
## validation-for-the-options-pattern"><a href="#validation-for-the-options-pattern">Validation For The Options Pattern
...
<li>`BindConfiguration` - binds the values from the configuration section
<li>`ValidateDataAnnotations` - enables **validation** using **data annotations**
...
## running-validation-at-application-start"><a href="#running-validation-at-application-start">Running Validation At Application Start
...
If you want to see how to implement the <a href="https://youtu.be/wxYt0motww0">**Options pattern**</a>,
I made a <a href="https://youtu.be/wxYt0motww0">**video about it where I go into the details.**</a>
...
I also made a video showing how to add <a href="https://youtu.be/qRruEdjNVNE">validation to the Option pattern</a>.
