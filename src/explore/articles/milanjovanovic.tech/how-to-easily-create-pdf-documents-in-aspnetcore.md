...
One of the most popular document formats for reporting purposes is <a href="https://en.wikipedia.org/wiki/PDF">PDF.</a>
...
## creating-pdf-files-with-questpdf"><a href="#creating-pdf-files-with-questpdf">Creating PDF Files With QuestPDF

<a href="https://www.questpdf.com/">QuestPDF</a> is an open-source .NET library for generating PDF documents.
...
- Fluent API
<li>Easy to use
<li>Good <a href="https://www.questpdf.com/introduction.html">documentation</a>

What I don't like about QuestPDF:

- Having to write a lot of code to create documents
<li>Limited scope of features
<li>No HTML-to-PDF support

**Licensing**

QuestPDF is free for small companies and development use.
There's also a commercial license for larger companies.
You can check out the licensing details <a href="https://www.questpdf.com/license/">here.</a>

---

## html-to-pdf-conversion-with-ironpdf"><a href="#html-to-pdf-conversion-with-ironpdf">HTML to PDF Conversion With IronPDF

The more common approach for generating PDF files is using an HTML template.

My favorite library that supports this is <a href="https://ironpdf.com/">IronPDF.</a>
...
and <a href="https://ironpdf.com/how-to/signing/">digitally signing PDF documents.</a>
...
An interesting implementation approach is using <a href="https://learn.microsoft.com/en-us/aspnet/core/mvc/views/overview?view=aspnetcore-7.0">ASP.NET Core MVC views</a>
...
<ul>
    ...
    {
        <li>@lineItem.Name | @lineItem.Price
    }
```
...
IronPDF is free for development use and has multiple pricing tiers for commercial use that you can check out <a href="https://ironpdf.com/licensing/">here.</a>
...
## exporting-pdf-files-from-an-api"><a href="#exporting-pdf-files-from-an-api">Exporting PDF Files From an API

It's pretty straightforward to return a PDF file from an API endpoint in ASP.NET Core.

Minimal APIs have the `Results.File` method accepting either a file path, stream, or byte array.
