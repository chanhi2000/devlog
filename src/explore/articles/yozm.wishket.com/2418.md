...
```component VPCard
{
  "title": "CPU usage over 100% if Intel Turbo Boost is active - Windows Client | Microsoft Learn",
  ...
  "link": "https://learn.microsoft.com/en-us/troubleshoot/windows-client/performance/cpu-usage-exceeds-100",
