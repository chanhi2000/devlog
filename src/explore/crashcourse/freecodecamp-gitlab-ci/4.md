...
description: 🥁Crashcourse > 🦊freecodecamp.org - DevOps with GitLab CI > Unit 4 - Deploying a dockerized application to AWS
tags: ["crashcourse", "gitlab", "yaml", "ci" ,"youtube", "freecodecamp", "vdespa"]
meta:
  - name: 🥁Crashcourse > 🦊freecodecamp.org - DevOps with GitLab CI > Unit 4 - Deploying a dockerized application to AWS
    content: Unit 4 - Deploying a dockerized application to AWS
  - property: og:title
    content: Unit 4 - Deploying a dockerized application to AWS
  - property: og:description
    content: 🥁Crashcourse > 🦊freecodecamp.org - DevOps with GitLab CI > Unit 4 - Deploying a dockerized application to AWS
  - property: og:url
    content: https://chanhi2000.github.io/explore/crashcourse/freecodecamp-gitlab-ci/4.html
---
