...
description: 🥁Crashcourse > 🦊freecodecamp.org - DevOps with GitLab CI > Unit 1 - Introduction to GitLab
tags: ["crashcourse", "gitlab", "yaml", "ci" ,"youtube", "freecodecamp", "vdespa"]
meta:
  - name: 🥁Crashcourse > 🦊freecodecamp.org - DevOps with GitLab CI > Unit 1 - Introduction to GitLab
    content: Unit 1 - Introduction to GitLab
  - property: og:title
    content: Unit 1 - Introduction to GitLab
  - property: og:description
    content: 🥁Crashcourse > 🦊freecodecamp.org - DevOps with GitLab CI > Unit 1 - Introduction to GitLab
  - property: og:url
    content: https://chanhi2000.github.io/explore/crashcourse/freecodecamp-gitlab-ci/1.html
---
