...
description: 🥁Crashcourse > 🦊freecodecamp.org - DevOps with GitLab CI > Unit 3 - Continuous Deployment with GitLab & AWS
tags: ["crashcourse", "gitlab", "yaml", "ci" ,"youtube", "freecodecamp", "vdespa"]
meta:
  - name: 🥁Crashcourse > 🦊freecodecamp.org - DevOps with GitLab CI > Unit 3 - Continuous Deployment with GitLab & AWS
    content: Unit 3 - Continuous Deployment with GitLab & AWS
  - property: og:title
    content: Unit 3 - Continuous Deployment with GitLab & AWS
  - property: og:description
    content: 🥁Crashcourse > 🦊freecodecamp.org - DevOps with GitLab CI > Unit 3 - Continuous Deployment with GitLab & AWS
  - property: og:url
    content: https://chanhi2000.github.io/explore/crashcourse/freecodecamp-gitlab-ci/3.html
---
