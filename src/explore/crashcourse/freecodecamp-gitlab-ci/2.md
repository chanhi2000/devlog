...
description: 🥁Crashcourse > 🦊freecodecamp.org - DevOps with GitLab CI > Unit 2 - Continuous Integration with GitLab CI
tags: ["crashcourse", "gitlab", "yaml", "ci" ,"youtube", "freecodecamp", "vdespa"]
meta:
  - name: 🥁Crashcourse > 🦊freecodecamp.org - DevOps with GitLab CI > Unit 2 - Continuous Integration with GitLab CI
    content: Unit 2 - Continuous Integration with GitLab CI
  - property: og:title
    content: Unit 2 - Continuous Integration with GitLab CI
  - property: og:description
    content: 🥁Crashcourse > 🦊freecodecamp.org - DevOps with GitLab CI > Unit 2 - Continuous Integration with GitLab CI
  - property: og:url
    content: https://chanhi2000.github.io/explore/crashcourse/freecodecamp-gitlab-ci/2.html
---
...
- [<FontIcon icon="iconfont icon-gitlab"/> `gitlab-course-public/freecodecamp-gitlab-ci` (fork this)](https://gitlab.com/gitlab-course-public/freecodecamp-gitlab-ci)
