...
- [<FontIcon icon="fas fa-feather-pointed"/>Maven > <FontIcon icon="fa-brands fa-youtube"/> Youtube](/programming/maven/youtube.md)
- [<FontIcon icon="fa-brands fa-java"/>Java > <FontIcon icon="fa-brands fa-youtube"/> Youtube](/programming/java/youtube.md)
- [<FontIcon icon="fa-brands fa-envira"/>Spring > <FontIcon icon="fa-brands fa-youtube"/> Youtube](/programming/java-spring/youtube.md)
...
- [<FontIcon icon="fa-brands fa-swift"/>Swift > <FontIcon icon="fa-brands fa-youtube"/> Youtube](/programming/swift/youtube.md)
...
- [<FontIcon icon="fas fa-hashtag"/>CSharp > <FontIcon icon="fa-brands fa-youtube"/> Youtube](/programming/csharp/youtube.md)
- [<FontIcon icon="fa-brands fa-golang"/>Go > <FontIcon icon="fa-brands fa-youtube"/> Youtube](/programming/go/youtube.md)
- [<FontIcon icon="iconfont icon-dart"/>Dart > <FontIcon icon="fa-brands fa-youtube"/> Youtube](/programming/dart/youtube.md)
