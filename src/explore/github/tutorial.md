...
- [dair-ai/Prompt-Engineering-Guide][dair-ai/Prompt-Engineering-Guide]: 🐙 Guide and resources for prompt engineering <GithubTags tagItems="deep-learning;openai;language-model;prompt-engineering;chatgpt" />
- [freeCodeCamp/freeCodeCamp][freeCodeCamp/freeCodeCamp]: freeCodeCamp.org's open-source codebase and curriculum. Learn to code for free. <GithubTags tagItems="react;nodejs;javascript;d3;teachers;community;education;programming;curriculum;math;freecodecamp;learn-to-code;nonprofits;careers;certification;hacktoberfest" />
