  ...
  :actions='[
    {
      ...
      text: "블로그",
      link: "https://www.acmicpc.net/blog/list",
    }
  ]'
/>
...
<SiteInfo
  name="Welcome to the Hugging Face Audio course! - Hugging Face Audio Course"
  ...
  preview="https://huggingface.co/front/thumbnails/learn/audio-course.png"/>

<SiteInfo
  name="Build an AI Image Recognition app using Gemini on Vertex AI | Google Cloud Skills Boost"
  desc="In this lab, you will learn how to use Google's Vertex AI SDK to interact with the powerful Gemini generative AI model, enabling you to ask questions about images and receive insightful text-based responses."
  url="https://www.cloudskillsboost.google/course_templates/1076/labs/488225"
...
<SiteInfo
  name="Build an AI Image Generator app using Imagen on Vertex AI | Google Cloud Skills Boost"
  desc="In this lab, you will learn how to use Google's Vertex AI SDK to interact with the pre-trained Image Generation AI model, enabling you to send text prompts to the AI model as an input for image generation and receive the image response generated by the AI model."
  url="https://www.cloudskillsboost.google/course_templates/1076/labs/488226"
  logo="https://www.cloudskillsboost.google/qwiklabs_logo_900x887.png"
  preview="https://cdn.qwiklabs.com/GMOHykaqmlTHiqEeQXTySaMXYPHeIvaqa2qHEzw6Occ%3D"/>

<SiteInfo
  name="Build an application to send Chat Prompts using the Gemini model | Google Cloud Skills Boost"
  desc="In this lab, you will learn how to use Google's Vertex AI SDK to interact with the powerful Gemini generative AI model, enabling you to send text based chat prompts as an input and receive personalized streaming and non-streaming chat responses."
  url="https://www.cloudskillsboost.google/course_templates/1076/labs/488227"
  logo="https://www.cloudskillsboost.google/qwiklabs_logo_900x887.png"
  preview="https://cdn.qwiklabs.com/GMOHykaqmlTHiqEeQXTySaMXYPHeIvaqa2qHEzw6Occ%3D"/>

<SiteInfo
  name="Build a Multi-Modal GenAI Application: Challenge Lab | Google Cloud Skills Boost"
  desc="This challenge lab evaluates your understanding of Google's Vertex AI SDK for integrating generative AI models to build an Image generator app, and an app which enables you to ask questions about images and receive insightful text-based responses."
