...
lang: ko-KR
title: Article(s)
description: Angular.js > Article(s)
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/freecodecamp.org/how-to-transform-an-angular-appl-with-signals.md",
  "logo": "https://cdn.freecodecamp.org/universal/favicons/favicon.ico",
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/consuming-graphql-api-angular.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/angular-authentication-actions-with-identityserver4.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/angular-oauth2-oidc-configuration-identityserver4.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
