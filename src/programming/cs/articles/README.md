...
```component VPCard
{
  ...
  "link": "/explore/articles/johnnyreilly.com/using-kernel-memory-to-chunk-documents-into-azure-ai-search.md",
  "logo": "https://johnnyreilly.com/favicon.ico",
  "background": "rgba(71,118,222,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/explore/articles/code-maze.com/net-core-web-development-part8.md",
  "logo": "/images/content/code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/explore/articles/code-maze.com/net-core-web-development-part9.md",
  "logo": "/images/content/code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/explore/articles/code-maze.com/net-core-web-development-part10.md",
  "logo": "/images/content/code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/explore/articles/code-maze.com/net-core-web-development-part11.md",
  "logo": "/images/content/code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/explore/articles/code-maze.com/net-core-web-development-part12.md",
  "logo": "/images/content/code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/explore/articles/code-maze.com/net-core-web-development-part13.md",
  "logo": "/images/content/code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/explore/articles/code-maze.com/net-core-web-development-part14.md",
  "logo": "/images/content/code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/explore/articles/code-maze.com/net-core-web-development-part15.md",
  "logo": "/images/content/code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/explore/articles/code-maze.com/net-core-web-development-part16.md",
  "logo": "/images/content/code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/explore/articles/code-maze.com/how-to-prepare-aspnetcore-app-dockerization.md",
  "logo": "/images/content/code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/explore/articles/code-maze.com/aspnetcore-webapi-best-practices.md",
  "logo": "/images/content/code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
