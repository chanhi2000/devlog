...
head:
  - - meta:
    ...
    - property: og:ription
      content: Article(s)
    - property: og:url
      content: https://chanhi2000.github.io/programming/cs-blazor/articles/
---
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/milanjovanovic.tech/flexible-pdf-reporting-in-net-using-razor-views.md",
  "logo": "https://milanjovanovic.tech/profile_favicon.png",
...
```component VPComponent
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/blazor-webassembly-introduction.md",
  "logo": "code-maze.com/favicon.png",
...
```component VPComponent
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/blazor-components.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPComponent
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/blazor-webassembly-pagination.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPComponent
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/blazor-webassembly-searching.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPComponent
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/blazor-webassembly-sorting.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPComponent
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/blazor-webassembly-forms-form-validation.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPComponent
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/blazor-webassembly-file-upload.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPComponent
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/blazor-webassembly-put-delete-calling-javascript-functions.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/using-access-token-with-blazor-webassembly-httpclient.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/how-to-secure-blazor-webassembly-with-identityserver4.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/refresh-token-with-blazor-webassembly-and-asp-net-core-web-api.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/creating-blazor-webassembly-signalr-charts.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/authenticationstateprovider-blazor-webassembly.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/blazor-webassembly-registration-aspnetcore-identity.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/blazor-webassembly-authentication-aspnetcore-identity.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/blazor-webassembly-role-based-authorization.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/blazor-webassembly-role-based-security-with-identityserver4.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/atribute-based-access-control-blazor-webassembly-identityserver4.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/how-to-call-javascript-code-from-net-blazor-webassembly.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/using-jsinterop-to-pass-html-elements-and-handle-js-errors.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/how-to-call-csharp-methods-from-javascript-in-blazor-webassembly.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/use-browser-functionalities-with-blazor-webassembly.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/wrapping-javascript-libraries-with-csharp-in-blazor-webassembly.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/lazy-loading-in-blazor-webassembly.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/global-http-error-handling-in-blazor-webassembly.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/blazor-webassembly-component-virtualization-with-web-api.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/localization-in-blazor-webassembly-applications.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/css-isolation-in-blazor-applications.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/custom-validation-in-blazor-webassembly.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/binding-in-blazor-applications.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/code-maze.com/complex-model-validation-in-blazor.md",
  "logo": "code-maze.com/favicon.png",
  "background": "rgba(22,22,22,0.2)"
}
```
